...
#Make oredict for tinkers slings
<ore:Slings>.add(<tconstruct:slimesling>);
<ore:Slings>.add(<tconstruct:slimesling:1>);
<ore:Slings>.add(<tconstruct:slimesling:2>);
<ore:Slings>.add(<tconstruct:slimesling:4>);
<ore:Slings>.add(<tconstruct:slimesling:3>);
...
#Oredict heavy sieves
<ore:Heavysieve>.add(<excompressum:heavy_sieve:5>);
<ore:Heavysieve>.add(<excompressum:heavy_sieve:4>);
<ore:Heavysieve>.add(<excompressum:heavy_sieve:3>);
<ore:Heavysieve>.add(<excompressum:heavy_sieve:2>);
<ore:Heavysieve>.add(<excompressum:heavy_sieve:1>);
<ore:Heavysieve>.add(<excompressum:heavy_sieve>);
