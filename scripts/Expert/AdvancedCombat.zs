...
recipes.addShaped(<advancedcombat:sharpness_upgrade>, [[<ore:paper>, <ore:Flintblock>, <ore:paper>], [<ore:Flintblock>, <minecraft:diamond_sword>, <ore:Flintblock>], [<ore:paper>, <ore:Flintblock>, <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:smite_upgrade>, [[<ore:paper>, <ore:ingotAlumite>, <ore:paper>], [<ore:ingotAlumite>, <ore:blockBone>, <ore:ingotAlumite>], [<ore:paper>, <ore:ingotAlumite>, <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:spider_upgrade:1>, [[<randomthings:ingredient:12>, <minecraft:fermented_spider_eye>, <randomthings:ingredient:12>], [<minecraft:fermented_spider_eye>, <advancedcombat:spider_upgrade>, <minecraft:fermented_spider_eye>], [<randomthings:ingredient:12>, <minecraft:fermented_spider_eye>, <randomthings:ingredient:12>]]);

#Change knockback upgrade
recipes.remove(<advancedcombat:knockback_upgrade>);
recipes.remove(<advancedcombat:knockback_upgrade:1>);
recipes.addShaped(<advancedcombat:knockback_upgrade>, [[<ore:paper>, <ore:Slings>, <ore:paper>], [<ore:Slings>, <tconstruct:slime_congealed:3>, <ore:Slings>], [<ore:paper>, <ore:Slings>, <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:fire_aspect_upgrade>, [[<ore:paper>, <tconstruct:firewood:1>, <ore:paper>], [<tconstruct:firewood:1>, <minecraft:flint_and_steel>, <tconstruct:firewood:1>], [<ore:paper>, <tconstruct:firewood:1>, <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:unbreaking_upgrade>, [[<ore:paper>, <tconstruct:large_plate>.withTag({Material: "obsidian"}), <ore:paper>], [<tconstruct:large_plate>.withTag({Material: "obsidian"}), <botania:manasteelchest>, <tconstruct:large_plate>.withTag({Material: "obsidian"})], [<ore:paper>, <tconstruct:large_plate>.withTag({Material: "obsidian"}), <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:blast_protection_upgrade>, [[<ore:paper>, <ore:ingotRefinedObsidian>, <ore:paper>], [<ore:ingotRefinedObsidian>, <tconstruct:throwball:1>, <ore:ingotRefinedObsidian>], [<ore:paper>, <ore:ingotRefinedObsidian>, <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:projectile_protection_upgrade>, [[<ore:paper>, <tconstruct:arrow_head>.withTag({Material: "xu_demonic_metal"}), <ore:paper>], [<tconstruct:arrow_head>.withTag({Material: "xu_demonic_metal"}), <advancedcombat:advanced_bow>, <tconstruct:arrow_head>.withTag({Material: "xu_demonic_metal"})], [<ore:paper>, <tconstruct:arrow_head>.withTag({Material: "xu_demonic_metal"}), <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:feather_falling_upgrade>, [[<ore:paper>, <mysticalagriculture:crafting:24>, <ore:paper>], [<mysticalagriculture:crafting:24>, <tconstruct:slime_congealed:2>, <mysticalagriculture:crafting:24>], [<ore:paper>, <mysticalagriculture:crafting:24>, <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:depth_strider_upgrade>, [[<ore:paper>, <ore:emeraldboots>, <ore:paper>], [<ore:emeraldboots>, <forge:bucketfilled>.withTag({FluidName: "obsidian", Amount: 1000}), <ore:emeraldboots>], [<ore:paper>, <ore:emeraldboots>, <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:efficiency_upgrade>, [[<ore:paper>, <forge:bucketfilled>.withTag({FluidName: "redstone", Amount: 1000}), <ore:paper>], [<forge:bucketfilled>.withTag({FluidName: "redstone", Amount: 1000}), <mysticalagriculture:inferium_pickaxe>, <forge:bucketfilled>.withTag({FluidName: "redstone", Amount: 1000})], [<ore:paper>, <forge:bucketfilled>.withTag({FluidName: "redstone", Amount: 1000}), <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:fortune_upgrade>, [[<ore:paper>, <mekanism:compresseddiamond>, <ore:paper>], [<mekanism:compresseddiamond>, <ic2:purified:1>, <mekanism:compresseddiamond>], [<ore:paper>, <mekanism:compresseddiamond>, <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:punch_upgrade>, [[<ore:paper>, <mysticalagriculture:prudentium_arrow>, <ore:paper>], [<mysticalagriculture:prudentium_arrow>, <tconstruct:materials:13>, <mysticalagriculture:prudentium_arrow>], [<ore:paper>, <mysticalagriculture:prudentium_arrow>, <ore:paper>]]);
...
recipes.addShaped(<advancedcombat:flame_upgrade>, [[<ore:paper>, <exnihilocreatio:item_doll>, <ore:paper>], [<exnihilocreatio:item_doll>, <ic2:crafting:18>, <exnihilocreatio:item_doll>], [<ore:paper>, <exnihilocreatio:item_doll>, <ore:paper>]]);
